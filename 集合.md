...
&ensp;&ensp;&ensp;&ensp;`Object remove(int index)` / `remove(Object obj)`：移除指定 index 位置的元素 / 移除指定元素，并返回此元素（注意 int 型参数会冲突）
...
&ensp;&ensp;&ensp;&ensp;`equals()` 返回 false，则元素 a 添加成功。**--->情况2**

...
&ensp;&ensp;&ensp;&ensp;`ArrayList list = new ArrayList();` 底层Object[] elementData初始化为{}

&ensp;&ensp;&ensp;&ensp;`list.add(123);` 第一次调用add()时，底层才创建了长度10的数组，并将数据123添加到elementData[0]
